...
class UserBuyCoinHistory extends StatefulWidget {
  static var tag = " ";

  @override
  UserBuyCoinHistoryState createState() => UserBuyCoinHistoryState();
}

class UserBuyCoinHistoryState extends State<UserBuyCoinHistory> {
  int selectedPos = 1;
  var dropdownNames;
  Future allhistory;
  ...
  void initState() {
    ...
    var theinternet2 = await functionfile.checkInternetAccess();
      ...
      if (theinternet && theinternet2) {
            setState(() {
      allhistory=historyapi.allbuycoinhistory(pg:1,search:" ");
      if(allhistory==null){
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
                       appBarwithlink(context, "Buy coin","/userdashboard"),
            Row(
