...
class UserBcHistory extends StatefulWidget {
  static var tag = " ";

  @override
  UserBcHistoryState createState() => UserBcHistoryState();
}

class UserBcHistoryState extends State<UserBcHistory> {
  int selectedPos = 1;
  var dropdownNames;
  Future allhistory;
  ...
  void initState() {
    ...
    var theinternet2 = await functionfile.checkInternetAccess();
      ...
      if (theinternet && theinternet2) {
            setState(() {
       allhistory=historyapi.allblockchistory(pg:1,search:" ");
            });
      }else{
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
                        appBarwithlink(context, "Blockchain","/userdashboard"),
            Row( 
