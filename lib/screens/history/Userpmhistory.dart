...
class UserPmHistory extends StatefulWidget {
  static var tag = " ";

  @override
  UserPmHistoryState createState() => UserPmHistoryState();
}

class UserPmHistoryState extends State<UserPmHistory> {
  int selectedPos = 1;
  var dropdownNames;
  Future allhistory;
  ...
  void initState() {
    ...
    var theinternet2 = await functionfile.checkInternetAccess();
      ...
      if (theinternet && theinternet2) {
            setState(() {
      allhistory=historyapi.allpmhistory(pg:1,search:" ");
            });
      }else{
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
                     appBarwithlink(context, "Perfect Money","/userdashboard"),
