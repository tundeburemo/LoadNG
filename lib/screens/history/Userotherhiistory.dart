...
class UserOtherHistory extends StatefulWidget {
  static var tag = " ";

  @override
  UserOtherHistoryState createState() => UserOtherHistoryState();
}

class UserOtherHistoryState extends State<UserOtherHistory> {
  int selectedPos = 1;
  var dropdownNames;
  Future allhistory;
  ...
  void initState() {
    ...
    var theinternet2 = await functionfile.checkInternetAccess();
      ...
      if (theinternet && theinternet2) {
            setState(() {
       allhistory=historyapi.allnewcoinshistory(pg:1,search:" ");
            });
      }else{
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
                       appBarwithlink(context, "Others","/userdashboard"),
            Row(
