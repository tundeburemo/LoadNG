...
class UserBizHistory extends StatefulWidget {
  static var tag = " ";

  @override
  UserBizHistoryState createState() => UserBizHistoryState();
}

class UserBizHistoryState extends State<UserBizHistory> {
  int selectedPos = 1;
  var dropdownNames;
  Future allhistory;
  ...
  void initState() {
    ...
    var theinternet2 = await functionfile.checkInternetAccess();
      ...
      if (theinternet && theinternet2) {
            setState(() {
      allhistory=historyapi.allbizhistory(pg:1,search:" ");
      if(allhistory==null){
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
                       appBarwithlink(context, "Business","/userdashboard"),
            Row(
