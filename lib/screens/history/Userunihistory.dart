...
class UserUniHistory extends StatefulWidget {
  static var tag = " ";

  @override
  UserUniHistoryState createState() => UserUniHistoryState();
}

class UserUniHistoryState extends State<UserUniHistory> {
  int selectedPos = 1;
  var dropdownNames;
  Future allhistory;
  ...
  void initState() {
    ...
    var theinternet2 = await functionfile.checkInternetAccess();
      ...
      if (theinternet && theinternet2) {
            setState(() {
      allhistory=historyapi.alluniversalhistory(pg:1,search:" ");
      if(allhistory==null){
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
                       appBarwithlink(context, "Universal","/userdashboard"),
            Row(
