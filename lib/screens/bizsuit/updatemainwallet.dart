...
class UpdateMainWalletBank extends StatefulWidget {
  static String tag = '/UpdateMainWalletBank';
  @override
  UpdateMainWalletBankState createState() => UpdateMainWalletBankState();
}

class UpdateMainWalletBankState extends State<UpdateMainWalletBank> {
...
Padding(
                    ...
                    Container(
                      ...
                      child: QIBusAppButton(
                        ...
                        onPressed: () {
                               ...
                               addwallet(bankacc:_selectedLocation);
                        },
                      ),
                    ),
                    SizedBox(
 ...
 addwallet({bankacc}) async {
    ...
    try {
      if (theinternet && theinternet2) {
       if (bankacc.isEmpty || bankacc == null || bankacc == '') {
          Navigator.of(context).pop();
          toast(
          ...
          var v = await bizsuitapi.userupdatemainwallet(bankselectedid:bankselectedid)
