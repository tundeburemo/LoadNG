...
import 'package:loadng/utils/codePicker/selection_dialog.dart';
  ...
  State<StatefulWidget> createState() {
    ...
    List<CountryCode> elements = jsonList
        .map((s) => CountryCode(
              ...
              // flagUri: 'https://iqonic.design/themeforest-images/prokit/eUrl/images/flags/images/flags/${s['code'].toLowerCase()}.png',
              flagUri: 'assets/flag/${s['code'].toLowerCase()}.png',
      ...
      _widget = FlatButton(
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            Flexible(
              fit: widget.alignLeft ? FlexFit.tight : FlexFit.loose,
              child: AppTextStyle.text(selectedItem.toCountryCodeString(),
                  textColor:  AppColors.black, fontSize: AppFontSize.textSizeMedium,fontFamily:AppFontSize.montlight ),
